...
const hardcodedGameList = [
  { id: 1,
    title: "Tank Survivor",
    description: "Come play this amazing tank dungeion battle!!!  Watch your tank grow more and more powerful as each wave of enemies gain in number and abilities",
